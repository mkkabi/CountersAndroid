...
public abstract class SampleTableAdapter extends BaseTableAdapter {
	...
	@Override
	public abstract View getView(int row, int column, View converView, ViewGroup parent);
	...
	void setTextColor(View view, int colorID){
        ((TextView) view.findViewById(android.R.id.text1)).setTextColor(colorID);
    }
	...
	public abstract void updateRowInDB(int row);
