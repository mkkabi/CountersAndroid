...
//                mDriveService.files().list().setSpaces("drive").execute()).addOnSuccessListener(fileList -> {
//              for (File file : fileList.getFiles()) {
//                file.remove("FileNameTst.csv");
//                  try {
//                      mDriveService.files().delete(name);
//                  } catch (IOException e) {
//                      e.printStackTrace();
//                  }
//              }
